...
python3 video_forward.py --makescore --model log/summe-split0/model_epoch1000.pth.tar --gpu 0 --dataset utils/train.h5 --save-dir logs/videolog/ --summary  --frm-dir utils/frames   
